...
public class Proxy implements Runnable {
    ...
    private static String cachedDirectory = "cached";
    ...
    static HashMap<String, String> overrideUrls;
    ...
    public Proxy(int port) {
        ...
        try {
            // Load in overridden urls from file
            File overriddenUrls = new File("overriddenUrls.txt");
            if (!overriddenUrls.exists()) {
                System.out.println("No overridden urls found - creating new file");
                overriddenUrls.createNewFile();
            } else {
                FileInputStream fileInputStream = new FileInputStream(overriddenUrls);
                ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);
                overrideUrls = (HashMap<String, String>) objectInputStream.readObject();
    ...
    /**
     * Looks for overridden url
     *
     * @param url of requested file
     * @return String if url is overridden, null otherwise
     */
    public static String getOverriddenUrl(String url) {
     ...
     * Adds a new page to the cache
     *
     * @param requestedUrl   URL of requested webpage
     * @param overridingUrl URL of webpage that will be targeted
     */
    public static void addUrlOverrides(String requestedUrl, String overridingUrl) {
        overrideUrls.put(requestedUrl, requestedUrl);
    }
