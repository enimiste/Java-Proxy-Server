...
public class RequestHandler implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            e.printStackTrace();
            out.println("Error reading request from client");
            return;
        }

        // Parse out URL
        out.println("Request Received " + requestString);
        ...
        if (Proxy.isBlocked(urlString)) {
            out.println("Blocked site requested : " + urlString);
        ...
        if (request.equals("CONNECT")) {
            out.println("HTTPS Request for : " + urlString + "\n");
            handleHTTPSRequest(urlString);
        } else {
            // Check if we have a cached copy
            File file;
            if ((file = Proxy.getCachedPage(urlString)) != null) {
                out.println("Cached Copy found for : " + urlString + "\n");
                sendCachedPageToClient(file);
            } else {
                String targetUrl;
                if ((targetUrl = Proxy.getOverriddenUrl(urlString)) != null) {
                    out.println("Overridden url found for : " + urlString + "\n");
                }
                if (targetUrl == null)
                    targetUrl = urlString;
                out.println("HTTP GET for : " + targetUrl + "\n");
                sendNonCachedToClient(targetUrl);
            }
        }
    }
    ...
    private void sendCachedPageToClient(File cachedFile) {
        ...
        try {
            ...
            if ((fileExtension.contains(".png")) || fileExtension.contains(".jpg") ||
                ...
                if (image == null) {
                    out.println("Image " + cachedFile.getName() + " was null");
            ...
            out.println("Error Sending Cached file to client");
            e.printStackTrace();
        }
    }
    ...
    private void sendNonCachedToClient(String urlString) {
        ...
        try {
            ...
            try {
                ...
                fileToCache = new File(Proxy.getCachedDirectory() + "/" + fileName);

                File cachedDirectory = fileToCache.getParentFile();
                ...
                out.println("Couldn't cache: " + fileName);
                caching = false;
                e.printStackTrace();
            } catch (NullPointerException e) {
                out.println("NPE opening file");
            }
            ...
            if ((fileExtension.contains(".png")) || fileExtension.contains(".jpg") ||
                ...
                if (image != null) {
                    ...
                    out.println("Sending 404 to client as image wasn't received from server"
                            + fileName);
    ...
    private void handleHTTPSRequest(String urlString) {
        ...
        try {
            ...
            out.println("Error on HTTPS : " + urlString);
            e.printStackTrace();
        }
    }
    ...
    class ClientToServerHttpsTransmit implements Runnable {
        ...
        public void run() {
            try {
                ...
                out.println("Proxy to client HTTPS read timed out");
                e.printStackTrace();
            }
        }
    }
    ...
    private void blockedSiteRequested() {
        try {
            ...
            out.println("Error writing to client when requested a blocked site");
            e.printStackTrace();
        }
    }
}
